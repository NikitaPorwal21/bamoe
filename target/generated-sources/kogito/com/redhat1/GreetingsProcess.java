...
public class GreetingsProcess extends org.kie.kogito.process.impl.AbstractProcess<com.redhat1.GreetingsModel> {
    ...
    @Override()
    public com.redhat1.GreetingsProcessInstance createInstance(com.redhat1.GreetingsModel value) {
        return new com.redhat1.GreetingsProcessInstance(this, value, this.createProcessRuntime());
    }

    public com.redhat1.GreetingsProcessInstance createInstance(java.lang.String businessKey, com.redhat1.GreetingsModel value) {
        return new com.redhat1.GreetingsProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    @Override()
    public com.redhat1.GreetingsModel createModel() {
        return new com.redhat1.GreetingsModel();
    }

    public com.redhat1.GreetingsProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((com.redhat1.GreetingsModel) value);
    }

    public com.redhat1.GreetingsProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (com.redhat1.GreetingsModel) value);
    }

    public com.redhat1.GreetingsProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.redhat1.GreetingsProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public com.redhat1.GreetingsProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.redhat1.GreetingsProcessInstance(this, this.createModel(), wpi);
    }
    ...
    public org.kie.api.definition.process.Process process() {
        ...
        factory.packageName("com.redhat1");
